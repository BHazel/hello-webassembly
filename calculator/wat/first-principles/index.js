...
function calculate() {
    ...
    switch (operation) {
        case 'add':
            result = wasmExports._add(number1, number2);
            break;
        case 'subtract':
            result = wasmExports._subtract(number1, number2);
            break;
        case 'multiply':
            result = wasmExports._multiply(number1, number2);
            break;
        case 'divide':
            result = wasmExports._divide(number1, number2);
            break;
        default:
